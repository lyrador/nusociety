 ...
 * @author raihan
 */
@WebFilter(filterName = "UrlRewriteFilter", urlPatterns = {"/Society/viewSociety/*"}, dispatcherTypes = {DispatcherType.REQUEST})
...
public class UrlRewriteFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(requestServletPath.endsWith("/Posts")) {
            ...
            if(requestServletPath.endsWith("/edit")) {
                String[] requestServletPathElements = requestServletPath.split("/");
                String societyName = requestServletPathElements[3];            
                String societyId = societyName.split("-")[0];
                
                httpServletRequest.getRequestDispatcher("/Society/editSociety.xhtml?societyId=" + societyId).forward(request, response);
            }
            
            if(requestServletPath.endsWith("/Events")) {
                String[] requestServletPathElements = requestServletPath.split("/");
                String societyName = requestServletPathElements[3];            
                String societyId = societyName.split("-")[0];
            ...
            if(requestServletPath.endsWith("/Announcement")) {
                String[] requestServletPathElements = requestServletPath.split("/");
                String societyName = requestServletPathElements[3];            
                String societyId = societyName.split("-")[0];
                
                httpServletRequest.getRequestDispatcher("/Announcement/leaderAnnouncementManagement.xhtml?societyId=" + societyId).forward(request, response);
            }
            
            if(requestServletPath.endsWith("/Home")) {
                String[] requestServletPathElements = requestServletPath.split("/");
                String societyName = requestServletPathElements[3];            
                String societyId = societyName.split("-")[0];
